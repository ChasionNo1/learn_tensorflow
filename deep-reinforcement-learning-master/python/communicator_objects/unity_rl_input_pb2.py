...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n)communicator_objects/unity_rl_input.proto\x12\x14\x63ommunicator_objects\x1a-communicator_objects/agent_action_proto.proto\x1a\x37\x63ommunicator_objects/environment_parameters_proto.proto\x1a(communicator_objects/command_proto.proto\"\xb4\x03\n\x0cUnityRLInput\x12K\n\ragent_actions\x18\x01 numpy \x03(\x0b\x32\x34.communicator_objects.UnityRLInput.AgentActionsEntry\x12P\n\x16\x65nvironment_parameters\x18\x02 \x01 numpy(\x0b\x32\x30.communicator_objects.EnvironmentParametersProto\x12\x13\n\x0bis_training\x18\x03 \x01 numpy(\x08\x12\x33\n\x07\x63ommand\x18\x04 \x01 numpy(\x0e\x32\".communicator_objects.CommandProto\x1aM\n\x14ListAgentActionProto\x12\x35\n\x05value\x18\x01 numpy \x03(\x0b\x32&.communicator_objects.AgentActionProto\x1al\n\x11\x41gentActionsEntry\x12\x0b\n\x03key\x18\x01 numpy \x01 numpy(\t\x12\x46\n\x05value\x18\x02 \x01 numpy(\x0b\x32\x37.communicator_objects.UnityRLInput.ListAgentActionProto:\x02\x38\x01 numpy\x42\x1f\xaa\x02\x1cMLAgents.CommunicatorObjectsb\x06proto3')
  ,
...
_UNITYRLINPUT_AGENTACTIONSENTRY = _descriptor.Descriptor(
  ...
  options=_descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001 numpy')),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_UNITYRLINPUT_AGENTACTIONSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001 numpy'))
