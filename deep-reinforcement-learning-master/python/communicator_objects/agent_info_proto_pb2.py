...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n+communicator_objects/agent_info_proto.proto\x12\x14\x63ommunicator_objects\"\xfd\x01 numpy\n\x0e\x41gentInfoProto\x12\"\n\x1astacked_vector_observation\x18\x01 numpy \x03(\x02\x12\x1b\n\x13visual_observations\x18\x02 \x03(\x0c\x12\x18\n\x10text_observation\x18\x03 \x01 numpy(\t\x12\x1d\n\x15stored_vector_actions\x18\x04 \x03(\x02\x12\x1b\n\x13stored_text_actions\x18\x05 \x01 numpy(\t\x12\x10\n\x08memories\x18\x06 \x03(\x02\x12\x0e\n\x06reward\x18\x07 \x01 numpy(\x02\x12\x0c\n\x04\x64one\x18\x08 \x01 numpy(\x08\x12\x18\n\x10max_step_reached\x18\t \x01 numpy(\x08\x12\n\n\x02id\x18\n \x01 numpy(\x05\x42\x1f\xaa\x02\x1cMLAgents.CommunicatorObjectsb\x06proto3')
)
